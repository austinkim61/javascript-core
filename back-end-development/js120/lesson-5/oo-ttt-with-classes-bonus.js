...
class TTTGame {
  ...
  computerMoves() {
    let choice = this.flexibleComputerMove(this.computer) ||
                 this.flexibleComputerMove(this.human) ||
